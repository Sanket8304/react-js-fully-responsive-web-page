    ...
    <HomeWrapper data={data}>
      <div
        ...
        <div>
          ...
          <p
            className={`${
              width > 1630 ? "text" : "responsive-text"
      ...
      <div className={`${width > 1790 ? "container" : "responsive-container"}`}>
        ...
        <div
          ...
          <div
            className={`${
              width > 1650 ? "text-container" : "responsive-text-container"
            }`}>
